...
# Output: .build/amtrino.app (signed + notarized when credentials exist,
# ad-hoc otherwise; selfchecked either way).
...
<dict>
    ...
    <key>NSHumanReadableCopyright</key><string>MIT — github.com/arian-shamaei/amtrino</string>
</dict>
</plist>
PLIST
